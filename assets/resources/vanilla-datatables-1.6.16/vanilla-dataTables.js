...
(function(root, factory) {
    ...
    proto.search = function (query) {
        ...
        // query = query.toLowerCase();             // Code rewritten (-) by...
        query = helper_function.removeAccents(query.toLowerCase()); // New code personalized added (+)
        ...
        each(this.data, function (row, idx) {
            ...
            var doesQueryMatch = query.split(" ").reduce(function (bool, word) {
                ...
                for (var x = 0; x < row.cells.length; x++) {
                    ...
                    content = helper_function.removeAccents(content);   // New code personalized added (+)
